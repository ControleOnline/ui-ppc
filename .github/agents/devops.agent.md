---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/ui-ppc, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/ui-ppc`.
...
- Checkout local: `app-community/modules/controleonline/ui-ppc`
